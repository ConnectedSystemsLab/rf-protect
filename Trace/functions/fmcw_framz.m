function [first_frame_index, num_data_frame_array] = fmcw_framz(channel0,trigger)
    ...
    num_data_frame_array = num_data_frame_array/2e6;
    num_data_frame_array = num_data_frame_array - num_data_frame_array(1);
    d_array = zeros(8,1);
    for j=1:1:8
%         figure;
%         plot(real(c0_f(j,:)))
